...
#                                            PW = S11_Power = N+1      
                                        ...
                                        if Time_Trace == 1:
                                            ...
                                            print (gainData_timeTrace.gainFrequency.shape)
                                        if Frequency_Spectrum == 1:                                            
                                            gainData_cst=gainData.GainData(fileNameS11CST,
                                                                            fileType='CST_S11',
                                                                            fMin=FLOW,fMax=FHIGH,
                                                                            comment='S11 obtained directly from cst')
#                                            if Impedance_Calculation == 1:
...
#                                                                                comment='Impedance obtained directly from cst')
    ...
    #                                       print (gainData_impedance.gainFrequency.shape)
                                        ...
                                        if ReCalculate_Impedance == 1:
                                            
                                            if Frequency_Spectrum != 1 and Time_Trace == 1:
                                                gainData_cst = gainData_timeTrace
                                            ...
                                            n.savetxt('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_0.%s-%s-%sPW%sCr_%s%s%s%s%s-%s_abs.txt' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),n.c_[gainData_cst.fAxis,10*S11_Power*n.log10(n.abs(gainData_cst.gainFrequency))],fmt=['%.6f','%.6f']) 
                                            n.savetxt('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_0.%s-%s-%sPW%sCr_%s%s%s%s%s-%s_pha.txt' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),n.c_[gainData_cst.fAxis,n.angle(gainData_cst.gainFrequency)],fmt=['%.6f','%.6f']) 
                                            n.savetxt('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/Impedance_0.%s-%s-%sPW%sCr_%s%s%s%s%s-%s_abs.txt' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),n.c_[gainData_cst.fAxis,n.abs(ImpedancePort)],fmt=['%.6f','%.6f']) 
                                            n.savetxt('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/Impedance_0.%s-%s-%sPW%sCr_%s%s%s%s%s-%s_pha.txt' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),n.c_[gainData_cst.fAxis,n.angle(ImpedancePort)],fmt=['%.6f','%.6f']) 

                                            
                                            print (gainData_cst.gainFrequency.shape)
                                            print (ImpedancePort.shape)
...
#                                            	p.plot(gainData_timeTrace.fAxis,10.*S11_Power*n.log10(n.abs(gainData_timeTrace.gainFrequency)),color='k',ls='-',marker='o',label='CST timetrace',markersize=4,markeredgecolor='none')
                                                ...
                                                p.xlabel('f (GHz)')
                                                p.legend(loc='best')
                                                p.title('S11_CST_Frequency_0.%s-%s-%sPW%s_%s%s%s%s%s-%s' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number)) 
                                                #p.show()
                                                p.grid()
                                                #p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapFeedOnly_Frequency.pdf',bbox_inches='tight')
                                                p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_CST_Frequency_0.%s-%s-%sPW%sCr_%s%s%s%s%s-%s.pdf' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),bbox_inches='tight')
                                                p.close()
    ...
    #												p.plot(gainData_timeTrace.tAxis,10.*S11_Power*n.log10(n.abs(gainData_timeTrace.gainDelay)),color='k',ls='-',marker='o',label='CST timetrace',markersize=4,markeredgecolor='none')
                                                ...
                                                p.xlabel('delay (ns)')
                                                p.legend(loc='best')
                                                p.title('S11_CST_Delay_0.%s-%s-%sPW%s_%s%s%s%s%s-%s' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number))
                                                #p.show()
                                                p.grid()
                                                #p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapFeedOnly_Delay.pdf',bbox_inches='tight')
                                                p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_CST_Delay_0.%s-%s-%sPW%sCr_%s%s%s%s%s-%s.pdf' %(Growth_Rate,Inner_Diameter, Outer_Diameter,S11_Power,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),bbox_inches='tight')
                                                p.close()
                                            
                                            
                                            p.plot(gainData_cst.fAxis,n.abs(ImpedancePort),color='k',ls='-',marker='o',label='CST Impedance Abs',markersize=4,markeredgecolor='none')
                                            p.xlim(.045,.255)
                                            p.ylabel('|Impedance(Abs)/Ohm')
                                            p.xlabel('f (GHz)')
                                            p.legend(loc='best')
                                            p.title('ImpedanceAbs_CST_Frequency_0.%s-%s-%s_%s%s%s%s%s-%s' %(Growth_Rate,Inner_Diameter, Outer_Diameter,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number)) 
                                            #p.show()
                                            p.grid()
                                            #p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapFeedOnly_Frequency.pdf',bbox_inches='tight')
                                            p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/ImpedanceAbs_CST_Frequency_0.%s-%s-%s_%s%s%s%s%s-%s.pdf' %(Growth_Rate,Inner_Diameter, Outer_Diameter,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),bbox_inches='tight')
                                            p.close()
                                            
                                            p.plot(gainData_cst.fAxis,n.angle(ImpedancePort),color='k',ls='-',marker='o',label='CST Impedance Pha',markersize=4,markeredgecolor='none')
                                            p.xlim(.045,.255)
                                            p.ylabel('|Impedance(Pha)/deg')
                                            p.xlabel('f (GHz)')
                                            p.legend(loc='best')
                                            p.title('ImpedancePha_CST_Frequency_0.%s-%s-%s_%s%s%s%s%s-%s' %(Growth_Rate,Inner_Diameter, Outer_Diameter,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number)) 
                                            #p.show()
                                            p.grid()
                                            #p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapFeedOnly_Frequency.pdf',bbox_inches='tight')
                                            p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/ImpedancePha_CST_Frequency_0.%s-%s-%s_%s%s%s%s%s-%s.pdf' %(Growth_Rate,Inner_Diameter, Outer_Diameter,Dish_Status,Impedance_Port_Recalculate_Status_List[1],Band_Status,Skirt_Status,BackPlane_Status,Port_Number),bbox_inches='tight')
                                            p.close()
