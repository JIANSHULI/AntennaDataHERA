...
for Growth_Rate in Growth_Rate_List:
	for Outer_Diameter in Outer_Diameter_List:
		...
		fileNameTimeTraceCST='/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/TimeDomain_0.%i-%i-%i.txt' %(Growth_Rate, Inner_Diameter,Outer_Diameter)
		fileNameS11CST='/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/S11_0.%i-%i-%i' %(Growth_Rate, Inner_Diameter,Outer_Diameter)
		#fileNameS11VNA='../reflectometry/RichBradley_GreenBank/TallCylinderGapOverDish_S11_Greenbank_RichBradley.d1'
		...
		p.xlabel('delay (ns)')
		p.legend(loc='best')
		p.title('S11_CST_Delay_0.%i-%i-%i_NF_PW%i' %(Growth_Rate, Inner_Diameter,Outer_Diameter,S11_Power))
		#p.show()
		p.grid()
		#p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapFeedOnly_Delay.pdf',bbox_inches='tight')
		p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_CST_Delay_0.%i-%i-%i_NF_PW%i.pdf'%(Growth_Rate, Inner_Diameter,Outer_Diameter,S11_Power),bbox_inches='tight')
		p.close()
		...
		p.xlabel('f (GHz)')
		p.legend(loc='best')
		p.title('S11_CST_Frequency_0.%i-%i-%i_NF_PW%i' %(Growth_Rate, Inner_Diameter,Outer_Diameter,S11_Power)) 
		#p.show()
		p.grid()
		#p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapFeedOnly_Frequency.pdf',bbox_inches='tight')
		p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_CST_Frequency_0.%i-%i-%i_NF_PW%i.pdf'%(Growth_Rate, Inner_Diameter,Outer_Diameter,S11_Power),bbox_inches='tight')
		p.close()