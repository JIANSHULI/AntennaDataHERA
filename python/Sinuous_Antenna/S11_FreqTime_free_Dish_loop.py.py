...
for Growth_Rate in Growth_Rate_List:
	for Outer_Diameter in Outer_Diameter_List:
		...
		p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_CST_Delay_0.%i-%i-%i_PW%i_dish.pdf'%(Growth_Rate, Inner_Diameter,Outer_Diameter,S11_Power),bbox_inches='tight')
		p.close()
		...
		p.savefig('/Users/JianshuLi/Documents/Miracle/Research/Cosmology/21cm Cosmology/Results/Sinuous_Antenna/Plots/S11_CST_Frequency_0.%i-%i-%i_PW%i_dish.pdf'%(Growth_Rate, Inner_Diameter,Outer_Diameter,S11_Power),bbox_inches='tight')
		p.close()